...
function Dashboard() {
    const dashboarMenuList = [
        {menuIcon:ShoppingCartIcon, menuName:'Place New Order', hoverName:'Place New Order'},
        {menuIcon:SettingsIcon, menuName:'Client Area', hoverName:'View and update your account details'},
        {menuIcon:HelpIcon, menuName:'Support', hoverName:'Find answer to your questions'}
    ];
